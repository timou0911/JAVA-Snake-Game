...
public class SnakeGame extends JPanel implements ActionListener, KeyListener {
    ...
    ImageIcon snakBombIcon = new ImageIcon("src/Images/green-bomb.png");
    Image snakeBombImage = snakBombIcon.getImage();
    ImageIcon snak2BombIcon = new ImageIcon("src/Images/yellow-bomb.png");
    Image snake2BombImage = snak2BombIcon.getImage();
